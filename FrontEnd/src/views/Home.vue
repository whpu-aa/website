...
#group-introduction {
  ...
  background-color: royalblue; /* 仅用来展示，在替换为真正的组件后删除 */
}
#about-us {
  height: 200px;

  background-color: greenyellow; /* 仅用来展示，在替换为真正的组件后删除 */
}
...
#carousel {
  ...
  background-color: indianred; /* 仅用来展示，在替换为真正的组件后删除 */
}

#daily-problem {
  flex-grow: 1;

  background-color: lightseagreen; /* 仅用来展示，在替换为真正的组件后删除 */
}
